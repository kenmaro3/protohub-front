...
export default class AuthService{
    ...
    static async registration(user_name: string, email: string, password: string): Promise<AxiosResponse<AuthResponse>>{
        return api.post<AuthResponse>('/auth/register', {user_name, email, password})
    }
